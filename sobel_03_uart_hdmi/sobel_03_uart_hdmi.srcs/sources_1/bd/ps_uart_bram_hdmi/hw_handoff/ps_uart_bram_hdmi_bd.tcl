...
################################################################
# This is a generated script based on design: ps_uart_bram_hdmi
#
...
# source ps_uart_bram_hdmi_script.tcl
...
set design_name ps_uart_bram_hdmi
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net BRAM_PORTB_addr_1 [get_bd_ports BRAM_PORTB_addr] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net BRAM_PORTB_clk_1 [get_bd_ports BRAM_PORTB_clk] [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net BRAM_PORTB_din_1 [get_bd_ports BRAM_PORTB_din] [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net BRAM_PORTB_en_1 [get_bd_ports BRAM_PORTB_en] [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net BRAM_PORTB_rst_1 [get_bd_ports BRAM_PORTB_rst] [get_bd_pins blk_mem_gen_0/rstb]
  connect_bd_net -net BRAM_PORTB_we_1 [get_bd_ports BRAM_PORTB_we] [get_bd_pins blk_mem_gen_0/web]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_ports BRAM_PORTB_dout] [get_bd_pins blk_mem_gen_0/doutb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
