# Create the PS UART + AXI BRAM block design for sobel_05.
# HDMI logic stays in RTL top.v to avoid module-reference OOC IP conflicts.
#
# Run from Vivado Tcl Console after opening sobel_05_pc_control_display.xpr:
#
#   cd D:/Github/FPGA-course/zynq7020-image-processing/sobel_05_pc_control_display
#   source create_ps_uart_control_hdmi_bd.tcl

set bd_name ps_uart_bram_hdmi
set script_dir [file dirname [file normalize [info script]]]
set src_dir [file join $script_dir sobel_05_pc_control_display.srcs sources_1 new]
...
proc remove_existing_bd_artifacts {bd_name script_dir} {
    ...
    foreach dir [list \
        [file join $script_dir sobel_05_pc_control_display.srcs sources_1 bd $bd_name] \
        [file join $script_dir sobel_05_pc_control_display.gen sources_1 bd $bd_name] \
        [file join $script_dir sobel_05_pc_control_display.ip_user_files bd $bd_name] \
    ] {
        if {[file exists $dir]} {
