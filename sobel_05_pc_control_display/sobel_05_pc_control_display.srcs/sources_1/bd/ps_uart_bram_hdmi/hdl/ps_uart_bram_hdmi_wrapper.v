...
//Command     : generate_target ps_uart_bram_hdmi_wrapper.bd
//Design      : ps_uart_bram_hdmi_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module ps_uart_bram_hdmi_wrapper
   (BRAM_PORTB_addr,
    BRAM_PORTB_clk,
    BRAM_PORTB_din,
    BRAM_PORTB_dout,
  ...
  ps_uart_bram_hdmi ps_uart_bram_hdmi_i
