...
#(
    parameter   [10:0]  IMG_HDISP = 11'd1920,            //  640*480
    parameter   [10:0]  IMG_VDISP = 11'd1080,
    parameter   [10:0]  DELAY_NUM = 11'd30              //  Interval period from the penultimate row to the last row
)
(
    //  global clock & reset
    input  wire                 clk                     ,
