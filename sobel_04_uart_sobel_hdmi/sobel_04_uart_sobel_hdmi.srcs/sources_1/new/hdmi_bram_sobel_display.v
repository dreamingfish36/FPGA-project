...
assign vs = vs_reg_d0;
assign de = de_reg_d0;
// Blue edge display mapping:
// edge_pixel = 8'h00 -> black background
// edge_pixel = 8'hFF or larger edge strength -> blue edge
assign rgb_r = (de_reg_d0 && sobel_done) ? 8'h00     : 8'h00;
assign rgb_g = (de_reg_d0 && sobel_done) ? 8'h00     : 8'h00;
