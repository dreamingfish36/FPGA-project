...
class CameraUartGui(tk.Tk):
    def __init__(self) -> None:
        ...
        self.control_mode_var = tk.StringVar(value="original - 原图")
    ...
    def _build_ui(self) -> None:
        ...
        self.control_mode_combo = ttk.Combobox(
            ...
            width=14,
            # ===== 修改点 S05-10MODE-D：GUI Mode 下拉框同步到 10 个显示模式 =====
            # 这里从 camera_uart_sender.py 的 DISPLAY_MODE_LABELS 读取，
            # GUI 会显示“英文 key - 中文解释”，避免别人不知道模式含义。
            # 后续如果要改名字或加模式，优先改 camera_uart_sender.py 里的 DISPLAY_MODES。
