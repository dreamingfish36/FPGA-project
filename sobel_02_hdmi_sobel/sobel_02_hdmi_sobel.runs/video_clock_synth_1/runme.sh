...
HD_PWD='F:/ax7020/2017/course_s1/hdmi_out_test/hdmi_out_test.runs/video_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_clock.tcl
