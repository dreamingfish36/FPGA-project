...
assign vs = vs_reg_d0;
assign de = de_reg_d0;
// Edge inverse display:
// edge_pixel = 8'h00 means background, edge_pixel = 8'hFF means edge.
// After inversion: background becomes white, edge becomes black.
assign edge_pixel_inv = 8'hFF - edge_pixel;

assign rgb_r = de_reg_d0 ? (sobel_done ? edge_pixel_inv : 8'hFF) : 8'h00;
assign rgb_g = de_reg_d0 ? (sobel_done ? edge_pixel_inv : 8'hFF) : 8'h00;
assign rgb_b = de_reg_d0 ? (sobel_done ? edge_pixel_inv : 8'hFF) : 8'h00;
